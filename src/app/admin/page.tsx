  ...
  return (
    <div className="space-y-8 max-w-7xl">
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-[#2A3E52] bg-card border border-border px-3 py-1.5 rounded-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2 bg-card border border-border rounded-xl p-5">
          <div className="flex items-center justify-between mb-5">
            ...
            <a href="/admin/leads" className="text-xs text-primary hover:text-primary-light flex items-center gap-1">
                ...
                return (
                  <div key={stage} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 bg-accent rounded-full h-1.5">
                      <div className={`h-1.5 rounded-full ${stage === "converted" ? "bg-emerald-400" : stage === "lost" ? "bg-red-400/50" : "bg-primary"}`} style={{ width: `${pct}%` }} />
                    </div>
        ...
        <div className="bg-card border border-border rounded-xl p-5">
          <div className="flex items-center justify-between mb-5">
            ...
            <a href="/admin/properties" className="text-xs text-primary hover:text-primary-light flex items-center gap-1">
            ...
            <div className="space-y-3">
              {Object.entries(ps.byType).map(([type, count]) => (
                <div key={type} className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium text-white bg-accent px-2.5 py-0.5 rounded-full">{count as number}</span>
                </div>
              ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="bg-card border border-border rounded-xl p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <a href="/admin/site-visits" className="text-xs text-primary hover:text-primary-light flex items-center gap-1">
          ...
          {uv.length > 0 ? (
            <div className="space-y-3">
              {uv.map((visit) => (
                <div key={visit._id} className="flex items-start gap-3 p-3 bg-accent/40 rounded-lg border border-white/[0.04]">
